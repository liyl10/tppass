...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/plan/js/plan_collection_list.js"></script>
		...
		<s:if test="pager.list.size > 0">
			<s:iterator value="pager.list" status="rowData">
				<tr>
					...
					<td align="center">
						 <s:property value="%{planCollectYear}" escape="true"/> 
					</td>
					<td>
						<s:property value="%{planCollectBatch}" escape="true"/>
					</td>
					<td>
						<s:property value="%{planCollectName}" escape="true"/>
					</td>
					<td align="center">
						<a href="javascript: void(0);" class="uline single" onclick="showPlanDetail('${planCollectId}');">查看</a>
						<a href="javascript: void(0);" class="uline single" onclick="editPlanDetail('${planCollectId}');">修改</a>
						<a href="javascript: void(0);" class="uline single" onclick="deletePlanDetail('${planCollectId}');">删除</a>
						<a href="javascript: void(0);" class="uline single" onclick="printPlanDetail('${planCollectId}');">打印</a>
					</td>
				</tr>
