...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/joint/js/select_expert_list.js"></script>
...
<div style=" margin-bottom: 0px;">
	<div align="left">
		<input class="button" type="button" id="batchSendMesBtn" value="发送通知" onclick="batchSendMessage();"/>
		&nbsp;
	</div>
</div>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-list">
		...
		<s:if test="pager.list.size > 0">
			<s:iterator value="pager.list" status="rowData">
				<tr>
					<td align="center">
						<input type="checkbox" value="${texpert.expertId}"/>
					</td>
					<td>
					...
					<td align="center">
						<a href="javascript: void(0);" class="uline single" onclick="sendMessage('<s:property value='%{texpert.expertId}' escape='true'/>');">发送通知</a>
					</td>
				</tr>
			</s:iterator>
		</s:if>
