...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/joint/js/batch_joint_insert.js"></script>
<s:hidden id="projectId" name="projectId" value="%{projectId}"></s:hidden>
<div align="center" style="padding: 10px;background: none repeat scroll 0 0 #FFFFFF;">
	<div style="text-align: left;">
		<div class="Servicel04">
			<div class="abuot02">
				<div class="abuot07">联席会批量审核</div>
					<div>
						<table width="100%" border=0 cellSpacing=0 cellPadding=0 class="t-list">
							<tr height="50px">
								...
								<td align="left">	
									...
									></s:radio>
						  	 		<!-- <textarea id="meetingOpinion" name="meetingOpinion"
							...
							<%-- <tr>
								...
								<td align="left" width="85%">
									<textarea id="commissionerOpinion" name="commissionerOpinion"
