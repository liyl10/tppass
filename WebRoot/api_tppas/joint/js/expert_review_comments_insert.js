...
$(function() {
	$(document).ready(function() {
		 path = $("#path").text();
		 upms.upmsUtils.initSelect("expertType","expertTypeValue", 0 , 1 , 0);
	});
});
...
$("#okBtn").bind("click", function() {
	...
	// 验证下拉列表
	var idList = new Array("expertType");
	...
	if (confirm($("#comfirmSave").text())){	
		...
		var arrParams = [ {name : "texpertReviewComments.expertType",targetid : "expertType",type : "select"}
						];
...
var actionUrl= path +"/api/superadmin/texpertreviewcommentsaction!operateExpertScoreByGroupList.action";
var $newPgDiv = $("#mainContent");
var arrParams = [];
arrParams = upms.upmsUtils.setSubmitDatas(arrParams, 1, 0);
var data = upms.transParsToObj(arrParams, $newPgDiv);
