...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/super/js/acceptanceModelSearch.js"></script>
<div align="center"
	style="padding: 10px; background: none repeat scroll 0 0 #FFFFFF;">
	<div style="text-align: left;">
		<div class="Servicel04">
			<div class="abuot02">
				<div class="abuot07">项目验收模板</div>
				<div>
					<form id="searchForm">
						<br>
...
<%-- 								<tag:auth code="ss.acceptanceModelSearch.search">
