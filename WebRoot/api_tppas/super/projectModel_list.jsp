...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/super/js/projectModel_list.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	class="t-list">
	<tr>
		<th style="text-align:center;white-space:nowrap">申报模板名称</th>
		...
		<th style="text-align:center;white-space:nowrap">初审地址</th>
	...
	<s:if test="pager.list.size  > 0">
		<s:iterator value="pager.list" status="rowData">
			<tr>
				<td><s:property value='%{reportTemplateName}' escape='true' /></td>
				...
				<td><s:property value='%{trialUrl}' escape='true' />&nbsp;</td>
				<td><s:property value='%{auditUrl}' escape='true' />&nbsp;</td>
				<td style="text-align: center; white-space: nowrap">
<%-- 				<tag:auth code="ss.projectModel_list.update"> --%>
				<a href="javascript: void(0);" name="detailBtn"
					onclick="doUpdate(
					'<s:property value='%{reportTemplateId}' escape='true'/>');">修改</a>
<%-- 					</tag:auth> --%>
<%-- 					<tag:auth code="ss.projectModel_list.delete"> --%>
					<a href="javascript: void(0);" name="delBtn"
					onclick="doDel('<s:property value='%{reportTemplateId}' escape='true'/>');">删除</a>
<%-- 					</tag:auth> --%>
					</td>
			</tr>
		</s:iterator>
