...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/contract/highTech/js/highTech_contract_contents_credit.js"></script>
...
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第一条</strong>   甲、乙、丙三方根据有关法律、法规和《西安市高新技术产业发展专项资金管理暂行办法》，为顺利完成西安市高新技术产业发展专项资金贷款贴息项目
...
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第二条</strong>   甲、乙、丙三方确认，本项目的执行期为自
...
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
1．甲方将分两次向乙方拨付贴息贷款。首次拨付在本合同生效、且乙方提交合法有效的借款合同、借款借据及付息单据的复印件后进行。首次拨款额为乙方首次提交有效付息单据额的70％，且以本合同第三条所规定的资金数额的70％为限。第二次拨付在本项目验收后进行，验收合格的，全额拨付资金余额；验收基本合格的拨付资金余额的60％；验收不合格的停拨资金余额。
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第五条</strong>  
 从 <s:property value='%{getText("{0,date,yyyy年MM月dd日}",{tcontract.contractDate})}' />起至本合同签字后一年内，如因各种原因乙方不能为实施本项目从银行金融机构贷款，甲方将取消向乙方的贴息计划，同时甲方有权终止合同。
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第六条</strong>   乙方须对本项目资金进行单独核算。乙方在收到甲、丙方拨款后作为冲减当期财务费用处理。
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第七条</strong>   本项目实施的阶段目标为乙方在项目申请材料的“产品化实施计划”中所表述的内容。
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
...
<br/>
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第八条</strong>   本项目的验收考核指标是：<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
1．企业指标：承担单位在合同到期时，在合同执行期内完成总投资
...
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第九条</strong>   在本合同签字生效后，乙方应该按照合同目标组织实施项目，在项目实施过程中接受甲方及其委托的地方监理单位的监督、检查，按照规定填报《高新技术产业发展专项项目监理信息调查表》半年报和年报，在本合同到期后按时进行项目验收，并对所提供的监理、验收信息的真实性负责。 <br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第十条</strong>   丙方有责任协助甲方对本项目的实施过程进行跟踪、检查和提供相关信息，并对所提供信息的客观真实性负责。<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第十一条</strong>   在本合同生效后5年内，甲方有权因非商业目的（如：在政府性会议、报告、文件、统计资料等）使用乙方企业、项目信息；乙方有义务在本项目产品包装以及产品宣传上说明本产品为西安市高新技术产业发展专项资金资助产品。<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第十二条</strong>   本合同的修改与解除。<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第十三条</strong>   本合同未尽事宜，参照《西安市高新技术产业发展专项资金管理暂行办法》、《西安市科技计划项目管理暂行办法》及相关管理规定执行。<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第十四条</strong>   本合同的甲方由西安市科学技术局、西安市财政局共同组成，由西安市科学技术局代表甲方签约。<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;
<strong>第十五条</strong>   本合同经签约各方签字盖章后生效，合同文本一式五份，甲方存三份，乙方存一份，丙方存一份。合同电子版软盘一份。<br/><br/>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr height="30px">
	<td align="left">
