...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/contract/highTech/js/highTech_contract_index_list.js"></script>
<form id="frmA"></form>
<div id="resultDiv">
...
<div class="abuot07">附件清单</div>
	<div style="border-bottom: 1px dashed #C9DEEE;"></div>
		<div id="dddd"
			style="float: left; font-size: 140%; padding-left: 20px"></div>
			<s:if test="%{Flag==0}">
			<div
