...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/contract/other/js/contract_cover.js"></script>
<form id="CoverForm">
...
<div style="text-align: left;">
	<div class="Servicel04">
		<div class="abuot02">
		<div align="right"> 
			计划类别:<s:property value='%{type}' escape='true'/> 
		</div>
		<div align="right"> 
			项目编号:<s:property value='%{tcontract.tprojectApplication.projectNumber}' escape='true'/> 
		</div>
			<div class="abuot07">
				西安市科技计划项目
				<br/>
...
<%-- <tr>
    <td width="20%" style="text-align:right">
    	<FONT color=red>*</FONT>课题名称
    </td>
    <td  colspan="3">
    	<input type="text" class="inputA"  maxlength="100" onblur="upms.upmsUtils.blurTextCheck(this,'课题名称',1,-1);" 
	    onfocus="upms.upmsUtils.textFocus(this)" id="topicTitle" name="tcontractCover.topicTitle" 
	    value="<s:property value='%{tcontractCover.topicTitle}' escape='true'/>"/>
	    <s:hidden id="hiddentopicTitle" name="hidden" value="课题名称,1,-1"></s:hidden>
    </td>
  </tr> --%> 
  <tr>
  ...
  <tr>
   ...
   <tr>
    <td style="text-align:right">
   		<FONT color=red>*</FONT>承 担 单 位 地 址
   	</td>
    <td colspan="3">
      <div
  ...
  <s:hidden id="hiddenaddress3" name="hidden" value="通讯地址级联"></s:hidden> 
	...
	<div style="float:left;width:4px;margin-top:0px;">&nbsp;</div>
	 <div style="float:left;width:250px;margin-top:0px;">
		...
		onblur="upms.upmsUtils.blurTextCheck(this,'承担单位地址',1,-1);" 
		onfocus="upms.upmsUtils.textFocus(this)" maxlength="20"
		/>
		<s:hidden id="hiddenaddress" name="hidden" value="承担单位地址,1,-1"></s:hidden>
	  </div>
	</td>
  </tr>
  <tr>
    <td style="text-align:right">
    	<FONT color=red>*</FONT>项目单位负责人
    </td>
    <td width="25%">
	    <input type="text" class="inputA" maxlength="10" 
	    	onblur="upms.upmsUtils.blurTextCheck(this,'项目单位负责人',1,-1);" 
	    	onfocus="upms.upmsUtils.textFocus(this)" id="unitCharge" 
	    	name="tcontractCover.unitCharge" 
	    	value="<s:property value='%{tcontractCover.unitCharge}' escape='true'/>"/>    
	    <s:hidden id="hiddenunitCharge" name="hidden" value="项目单位负责人,1,-1"></s:hidden>
	</td>
	<td colspan="2" width="30%" >&nbsp;&nbsp;<FONT color=red>*</FONT>联系电话
	    <input type="text" class="inputA" maxlength="13" 
	    	onblur="upms.upmsUtils.blurTextCheck(this,'联系电话',1,1);" 
	    	onfocus="upms.upmsUtils.textFocus(this)" id="unitChargePhone1" 
	    	name="tcontractCover.unitChargePhone1" 
	    	value="<s:property value='%{tcontractCover.unitChargePhone1}' escape='true'/>"
	    	/>
	    <s:hidden id="hiddenunitChargePhone1" name="hidden" value="联系电话,1,1"></s:hidden>
	</td>
  </tr>
  <tr>
    <td style="text-align:right">
    ...
    <td width="20%">
        <input type="text" class="inputA" maxlength="10" 
        onblur="upms.upmsUtils.blurTextCheck(this,'项目负责人',1,-1);" 
        onfocus="upms.upmsUtils.textFocus(this)" id="charge" 
        name="tcontractCover.charge" 
        value="<s:property value='%{tcontractCover.charge}' escape='true'/>"/>    
        <s:hidden id="hiddencharge" name="hidden" value="项目负责人,1,-1"></s:hidden>
    </td>
    <td width="20%" >&nbsp;&nbsp;<FONT color=red>*</FONT>联系电话（办公电话）
	    <input type="text" class="inputA" maxlength="13" 
	    onblur="upms.upmsUtils.blurTextCheck(this,'办公电话',1,1);" 
	    	onfocus="upms.upmsUtils.textFocus(this)" id="chargePhone1" 
	    	name="tcontractCover.chargePhone1" 
	    	value="<s:property value='%{tcontractCover.chargePhone1}' escape='true'/>"
	    	style="width:100px"/>
	    <s:hidden id="hiddenchargePhone1" name="hidden" value="办公电话,1,1"></s:hidden>
	</td>
	<td width="50%" >&nbsp;&nbsp;<FONT color=red>*</FONT>（手机）
	    <input type="text" class="inputA"  maxlength="11" 
	    onblur="upms.upmsUtils.blurTextCheck(this,'手机',1,0);" 
	    onfocus="upms.upmsUtils.textFocus(this)" id="chargePhone2" 
	    name="tcontractCover.chargePhone2" 
	    value="<s:property value='%{tcontractCover.chargePhone2}' escape='true'/>"
	     onkeypress="return upms.upmsUtils.isNum(event,this)" style="width:100px"/>
	    <s:hidden id="hiddenchargePhone2" name="hidden" value="手机,1,0"></s:hidden>
	</td>
  </tr>
  <tr>
    <td style="text-align:right">
    ...
    <td width="20%">
        <input type="text" class="inputA" maxlength="10" 
        onblur="upms.upmsUtils.blurTextCheck(this,'项目联系人',1,-1);" 
        onfocus="upms.upmsUtils.textFocus(this)" id="contact" 
        name="tcontractCover.contact" 
        value="<s:property value='%{tcontractCover.contact}' escape='true'/>"/>    
        <s:hidden id="hiddencontact" name="hidden" value="项目联系人,1,-1"></s:hidden>
    </td>
    <td width="20%" >&nbsp;&nbsp;<FONT color=red>*</FONT>联系电话（办公电话）
	    <input type="text" class="inputA" maxlength="13" 
	    onblur="upms.upmsUtils.blurTextCheck(this,'办公电话',1,1);" 
	    onfocus="upms.upmsUtils.textFocus(this)" id="contactPhone1" 
	    name="tcontractCover.contactPhone1" 
	    value="<s:property value='%{tcontractCover.contactPhone1}' escape='true'/>"
	    style="width:100px"/>
	    <s:hidden id="hiddencontactPhone1" name="hidden" value="办公电话,1,1"></s:hidden>
	</td>
	<td width="50%" >&nbsp;&nbsp;<FONT color=red>*</FONT>（手机）
	    <input type="text" class="inputA"  maxlength="11" 
	    onblur="upms.upmsUtils.blurTextCheck(this,'手机',1,0);" 
	    onfocus="upms.upmsUtils.textFocus(this)" id="contactPhone2" 
	    name="tcontractCover.contactPhone2" 
	    value="<s:property value='%{tcontractCover.contactPhone2}' escape='true'/>"
	     onkeypress="return upms.upmsUtils.isNum(event,this)" style="width:100px"/>
	    <s:hidden id="hiddencontactPhone2" name="hidden" value="手机,1,0"></s:hidden>
    </td>
  </tr>
</table>
<br/>
...
<br/>
<div align="center">
	<s:property value='%{contractComment}'/>
</div>
<br/>
<div align="center">
<s:if test="%{Flag==0}">
	...
	<INPUT class="txt w184p Wdate" type="text" name="tcontractCover.contractTime" 
	    ...
	    onblur="upms.upmsUtils.blurTextCheck(this,'日期',1,-1);"  
	    onfocus="upms.upmsUtils.textFocus(this)"/>
	<s:hidden id="hiddencontractTime" name="hidden" value="日期,1,-1"></s:hidden>
</td>
</s:if>
<s:else>
