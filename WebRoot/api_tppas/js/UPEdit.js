			...
			checkOsBrowser: function() {
				...
				if((navigator.platform =="Win32") || (navigator.platform =="Windows")){
					if(navigator.userAgent.indexOf("MSIE")>0){
						...
						if(this.upeVersion!=undefined && this.upeVersion!="" && this.upeVersion!=UPEdit_FF_VERSION){
					...
					if(avigator.userAgent.indexOf("Android")>0){
                        userosbrowser=7;//Android
                     }
					
					if(this.upeVersion!=undefined && this.upeVersion!="" && this.upeVersion!=UPEdit_Linux_VERSION){
						this.upeDownText="请点此升级控件";
					}
				}else if(navigator.userAgent.indexOf("Macintosh")>0){
					userosbrowser=6;//macos
					this.upeditFFExe=UPEdit_MacOs;
					if(this.upeVersion!=undefined && this.upeVersion!="" && this.upeVersion!=UPEdit_MacOs_VERSION){
						this.upeDownText="请点此升级控件";
					}
				}
