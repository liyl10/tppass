(function(A) {
    A.extend(A.fn, {
        pstrength: function(B) {
            var B = A.extend({
                verdects: ["很弱", "弱", "中等", "强", "很强"],
                colors: ["#f00", "#c06", "#f60", "#3c0", "#3f0"],
                scores: [10, 15, 30, 40],
                common: ["password", "sex", "god", "test", "123", "liverpool", "letmein", "qwerty", "monkey"],
                minchar: 6
            },  B);
            return this.each(function() {
                var C = A(this).attr("id");
                //A(this).after("<em class=\"pstrength-minchar\" id=\"" + C + "_minchar\">最少需要输入" + B.minchar + "个字符</em>");
