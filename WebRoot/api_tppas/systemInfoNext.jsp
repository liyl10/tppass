		...
		<div class="Servicel04">
			<div class="abuot02">
				...
				<div class="c"><br><s:property value='%{retMsg}' escape='true'/><br>&nbsp;</div>
					...
					<input type="button" class="button" name="btnReturn" id="btnReturn" value="下一步"></div>
...
$("#btnReturn").bind("click", function() {
	...
	//alert(actionUrl);
 	upms.showOverLay();// 打开遮罩
 	var $newPgDiv = $("#mainContent");
/* 	var $newPgDiv = upms.getCurrPageDiv();
	if($newPgDiv.length==0){
		$newPgDiv = upms.createPageDiv();
	} */
