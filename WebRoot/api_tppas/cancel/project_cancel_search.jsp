...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/cancel/js/project_cancel_search.js"></script>

<div align="center" style="padding: 10px;background: none repeat scroll 0 0 #FFFFFF;">
  <div style="text-align: left;">
    <div class="Servicel04">
      <div class="abuot02">
        <div class="abuot07">项目撤销</div>
        <div>
          <form id="searchForm">
			  ...
			  <tr>
				...
				<td style="padding: 4px 8px; text-align: left">
					<s:select style="width:12em;" list="technicalFisldList" label="abc" listKey="itemId"
						listValue="itemName" id="technicalFisld" name="tprojectInfoa.technicalFisld" 
						value="%{tprojectInfoa.technicalFisld}" onblur="upms.upmsUtils.blurTextCheck(this,'单位所属行业领域');" onfocus="upms.upmsUtils.textFocus(this);"></s:select>
						<s:hidden id="technicalFisldValue" value="%{tprojectInfoa.technicalFisld}"></s:hidden>
