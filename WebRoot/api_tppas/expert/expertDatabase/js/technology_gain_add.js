	...
	$("#saveBut").click(function(){
		...
		if (confirm(comfirmInfo)){
			var actionUrl= path + "/api/expert/ttechnologyGainAction!saveTtechnologyGain.action?optType=0&now="+new Date().getTime();
	...
	function returnList(expertId){
		var actionUrl= path + "/api/expert/ttechnologyGainAction!list.action?optType=0&expertId="+expertId+"&now="+new Date().getTime();
		upms.showOverLay();// 打开遮罩
		var $newPgDiv = $("#content");
