...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/expert/expertManager/js/audit_high_tech_menu.js"></script>
<div class="leftNav">
		...
		<dl class="acc_nav">
			...
			<s:if test="menuList.size > 0">
				...
				<dd class="subNav" id="subNav<s:property value='%{menuList.size()+1}'/>">
					<a href="javascript: void(0);" onclick="expertAudit('${projectId}','${applyStatus}','${scoreId }');">
						专家评审
					</a>
				</dd>
			</s:if>
...
<s:hidden id="lastNext" name="lastNext" value="zjsh"></s:hidden>
<div id="content"></div>