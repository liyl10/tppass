...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/report/other/js/report_researcher_insert.js"></script>
<div align="center" style="padding: 10px;background: none repeat scroll 0 0 #FFFFFF;">
<div style="text-align: left;">
<div class="Servicel04">
<div class="abuot02">
				<div class="abuot07">主要研究人员_查看</div>
...
<tr>
	<td width="40%" style="padding: 4px 8px; text-align: right">
		<FONT color=red>*</FONT>技术职称
	</td>
	<td width="60%" style="padding: 4px 8px; text-align: left">
	<input id="job" name="tresearcher.job" 
		value="<s:property value='%{tresearcher.job}' escape='true'/>"
		type="text" style="width: 14.5em; height:1.6em;" class="inputA"
		maxlength="50" onblur="upms.upmsUtils.blurTextCheck(this,'技术职称',1,-1)"/>
	</td><s:hidden id="hiddenjob" name="hidden" value="技术职称,1,-1"></s:hidden>
</tr>
<tr>
	<td width="40%" style="padding: 4px 8px; text-align: right">
...
<tr>
	...
	<td width="60%" style="padding: 4px 8px; text-align: left">
		...
		type="text" style="width: 14.5em; height:1.6em;" class="inputA"
		maxlength="50"
		onblur="upms.upmsUtils.blurTextCheck(this,'部门及职务',1,-1)"
		/>
	</td><s:hidden id="hiddendepartment" name="hidden" value="部门及职务,1,-1"></s:hidden>
</tr>
<tr>
	<td width="40%" style="padding: 4px 8px; text-align: right">
...
<div align="right" style="width: 45%;float: left;">
