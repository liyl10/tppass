...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/report/other/js/report_researcher_list.js"></script>
	...
	<s:if test="pager.list.size > 0">
        ...
        <tr align=middle>
			...
			<td><div align="left"><s:property value='%{revealOrder}' escape='true'/></div></td>        
          	<td><div align="center">
          	<a href="javascript: void(0);" onclick="showDetai2('${projectId }','${researcherId}','${applyStatus}');">详细</a>
