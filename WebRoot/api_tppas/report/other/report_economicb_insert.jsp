...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/report/other/js/report_economicb_insert.js"></script>
...
<div align="center" style="padding: 10px; background: none repeat scroll 0 0 #FFFFFF;">
		<div style="text-align: left;">
			<div class="Servicel04">
				<div class="abuot02">
					<div class="abuot07">执行期内项目完成的经济指标</div>
	...
	<TABLE id='testtab' border=0 cellSpacing=0 cellPadding=0 width=95% align=center class="t-list">
        <TR>
		  <Th width="16%">预期经济效益</Th>
		  <Th width="21%">新增销售收入</Th>
		  <Th width="21%">新增税金</Th>
		  <Th width="21%">新增利润</Th>
		...
		<TR align="right">
			...
			<TD align="left">
			<input class="inputA" id="outputValue" name="teconomicIndicator.outputValue" type="text" style="width: 14.5em;ime-mode: disabled;" 
			value="<s:property value='%{teconomicIndicator.outputValue}' escape='true'/>"
			onblur="upms.upmsUtils.blurTextCheck(this,'销售收入',1,2);" onfocus="upms.upmsUtils.textFocus(this);" maxlength="13"
			...
			onblur="upms.upmsUtils.blurTextCheck(this,'所交缴税',1,2);" onfocus="upms.upmsUtils.textFocus(this);" maxlength="13"
			onkeypress="return upms.upmsUtils.isFloatNum(event,this)"/>
			...
			onblur="upms.upmsUtils.blurTextCheck(this,'净利润',1,2);" onfocus="upms.upmsUtils.textFocus(this);" maxlength="13"
			onkeypress="return upms.upmsUtils.isFloatNum(event,this)"/>
			...
			onblur="upms.upmsUtils.blurTextCheck(this,'创汇',1,2);" onfocus="upms.upmsUtils.textFocus(this);" maxlength="13"
			onkeypress="return upms.upmsUtils.isFloatNum(event,this)"/>
          ...
          <TR align="right">
			...
			<TD align="left">
			<input class="inputA" id="outputValue1" name="teconomicIndicator.outputValue1" type="text" style="width: 14.5em;ime-mode: disabled;" 
        ...
        <TR align="right">
			<s:if test="%{year3=='' || year3==null}">
				...
				<TD align="left">
				<input class="inputA" id="outputValue2" name="teconomicIndicator.outputValue2" type="text" style="width: 14.5em;ime-mode: disabled;" 
				value="<s:property value='%{teconomicIndicator.outputValue2}' escape='true'/>"
				onblur="upms.upmsUtils.blurTextCheck(this,'销售收入',0,2);" onfocus="upms.upmsUtils.textFocus(this);" maxlength="13"
				onkeypress="return upms.upmsUtils.isFloatNum(event,this)"/>
				</TD><s:hidden id="hiddenoutputValue2" name="hidden" value="销售收入,0,2"></s:hidden>
				<TD align="left">
				...
				onblur="upms.upmsUtils.blurTextCheck(this,'所交缴税',0,2);" onfocus="upms.upmsUtils.textFocus(this);" maxlength="13"
				onkeypress="return upms.upmsUtils.isFloatNum(event,this)"/>
				</TD><s:hidden id="hiddenpayTaxes2" name="hidden" value="所交缴税,0,2"></s:hidden>
				<TD align="left">
				...
				onblur="upms.upmsUtils.blurTextCheck(this,'净利润',0,2);" onfocus="upms.upmsUtils.textFocus(this);" maxlength="13"
				onkeypress="return upms.upmsUtils.isFloatNum(event,this)"/>
				...
				onblur="upms.upmsUtils.blurTextCheck(this,'创汇',0,2);" onfocus="upms.upmsUtils.textFocus(this);" maxlength="13"
				onkeypress="return upms.upmsUtils.isFloatNum(event,this)"/>
