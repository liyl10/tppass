...
$("#okBtn").bind("click", function(){
	...
	if (confirm($("#comfirmSave").text())){
		...
		var actionUrl= path + "/server/report/technicalIndexes!saveTechnicalIndexes.action?now="+new Date().getTime();
		//alert(actionUrl);
...
$("#nextBtn").bind("click", function(){
	...
	if (confirm($("#comfirmSaveNext").text())){
		...
		var actionUrl= path + "/server/report/technicalIndexes!nextTechnicalIndexes.action?now="+new Date().getTime();
		//alert(actionUrl);
		upms.showOverLay();// 打开遮罩
		var $newPgDiv = $("#content");
		var arrParams = [];
...
$("#nextBtn1").bind("click", function(){
	...
	var actionUrl= path + "/api/report/teconomicIndicatorBAction!initOther.action?now="+new Date().getTime();
	//alert(actionUrl);
	upms.showOverLay();// 打开遮罩
	var $newPgDiv = $("#content");
