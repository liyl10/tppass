...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/report/js/before_review_list.js"></script>
		...
		<s:if test="pager.list.size > 0">
			<s:iterator value="pager.list" status="rowData">
				<tr>
					...
					<td align="center">
						<a href="javascript: void(0);" class="uline single" onclick="beforeReview('${projectId}','<s:property value="#application[typeId+'-sb-trial']"/>');">项目初审</a>
						<a href="javascript: void(0);" class="uline single" onclick="applyRedistribute('${projectId}');">申请调配</a>
					</td>
				</tr>
			</s:iterator>
		</s:if>
