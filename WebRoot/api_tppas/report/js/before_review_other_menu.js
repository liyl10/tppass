	...
	$(function() {
		 $(document).ready(function () {
			...
			$("#content").load(path + "/api/report/tprojectApplicationAction!showUpdateNonTechCover.action?projectId="+$("#projectId").val()+"&applyStatus="+$("#applyStatus").val()+"&now=" + new Date().getTime());
		});
	}); 
	...
	//专家评审
	function expertAudit(projectId ,applyStatus){
