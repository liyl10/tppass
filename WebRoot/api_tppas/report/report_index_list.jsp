...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/report/js/report_index_list.js"></script>
...
<label id="comfirmDelete" style="display: none"><s:text name="confirm_del_info"/></label>
	...
	<s:if test="%{applyStatus==1}">
		<div id="dddd"
			style="float: left; font-size: 140%; padding-left: 20px">
		</div> 
		<div
...
<div align="center" style="width:100%">
	<input class="button save" id="nextBtn" name="button" type="button"  value="下一步"/>
</div>
</div>