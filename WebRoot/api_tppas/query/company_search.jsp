          ...
          <form id="searchForm">
            <table style="width:100%">
              <tr>
                ...
                <td style="white-space:nowrap;width:10%;text-align:right;padding:2 2 10 10;font-size:105%"> 申请单位
                  &nbsp;</td>
                <td style="white-space:nowrap;width:20%;padding:2px">&nbsp;<input type=text class="inputA">
                </td>
                <td style="white-space:nowrap;width:10%;text-align:right;padding:2 2 10 10;font-size:105%"> 项目负责人
                  &nbsp;</td>
                <td style="white-space:nowrap;width:20%;padding:2px">&nbsp;<input type=text class="inputA">
                </td>
              </tr>
              <tr>
                <td style="white-space:nowrap;width:10%;text-align:right;padding:2 2 10 10;font-size:105%"> 单位所属领域
                  &nbsp;</td>
                <td style="white-space:nowrap;width:20%;padding:2px">&nbsp;<select id="accountStatus" name="accountStatus" style="width:80%">
					<option value="0">全部</option>
                    <option value="1">软件开发类</option>
                    <option value="2">公共服务平台类</option>
                  </select>
                </td>
                <td style="white-space:nowrap;width:10%;text-align:right;padding:2 2 10 10;font-size:105%"> 申请单位性质
                  &nbsp;</td>
                <td style="white-space:nowrap;width:20%;padding:2px">&nbsp;<select id="accountStatus" name="accountStatus" style="width:80%">
					<option value="0">全部</option>
                ...
                <td style="white-space:nowrap;width:10%;text-align:right;padding:2 2 10 10;font-size:105%"> 申请单位所属区域
                  &nbsp;</td>
                <td style="white-space:nowrap;width:20%;padding:2px;">&nbsp;<select id="accountStatus" name="accountStatus" style="width:80%">
					<option value="0">全部</option>
