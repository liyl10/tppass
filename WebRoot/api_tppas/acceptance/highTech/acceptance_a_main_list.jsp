...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/acceptance/highTech/js/acceptance_a_main_list.js"></script>
...
<div align="center" style="padding: 10px;background: none repeat scroll 0 0 #FFFFFF;">
	<div style="text-align: left;">
		<div class="Servicel04">
			<div class="abuot02">
				<div class="abuot07">项目主要参加人员名单</div>
					<div style="border-bottom: 1px dashed #C9DEEE;"></div>
					<s:if test="%{acceptanceStatus ==1}">
					<div style="margin-right:20px; text-align:right;">
						<input class="button save" name="insertBtn" id="insertBtn" type="button" href="javascript: void(0);" value="新增"/>
					</div>
					</s:if>
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-list">
							...
							<tr>
								...
								<s:if test="%{acceptanceStatus ==1}">
								<td><div align="center">
									<a href="javascript: void(0);" onclick="modifyMain('${participateId}');">查看</a>
								</div></td>
								</s:if>
							</tr>
							</s:iterator>
