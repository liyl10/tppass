...
// 修改按钮
function modifyMain(participateId) {
	var actionUrl= path + "/api/acceptance/mainA!mainUpdateInit.action?participateId=" + participateId + "&now="+ new Date().getTime();
...
upms.pagequery.initpaging({// 分页
	...
	url:path +"/api/acceptance/mainA!mainInit.action?acceptanceId="
			+ $("#acceptanceId").val()
