...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/auditExpertSelect/js/change_group.js"></script>
</head>
<div align="center" style="padding: 10px;background: none repeat scroll 0 0 #FFFFFF;">
	<div style="text-align: left;">
		<div class="Servicel04" style="min-height: 350px;">
			<div class="abuot02">
				<div class="abuot07">项目分组选择</div>
						...
						<table width="100%">
							<tr>
								...
								<td style="white-space:nowrap;width:26%;padding:2px">
									...
									id="projectGroupSon" name="projectGroupSon" style="width:15.5em;"></s:select>
								</td>
								<s:hidden id="projectGroupSonValue" name="projectGroupSonValue" value="%{projectGroupSon}"></s:hidden>
							</tr>
						</table>
					</div>
			</div>
