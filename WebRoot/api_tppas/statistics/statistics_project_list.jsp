...
<script type="text/javascript" src="${pageContext.request.contextPath}/api_tppas/statistics/js/statistics_project_list.js"></script>
...
<!-- 查询结果列表S -->
 ...
 <%--    <th>操作</th>--%>  
	...
	<tr>
		...
		<td><a href="javascript: void(0);" onclick="viewCompanyInfo('${projectId}');">
		...
		<td><s:property value='%{applyStatus}' escape='true'/></td>
		<td><s:property value='%{contractStatus}' escape='true'/></td>
		<td>&nbsp;</td>
		<%-- <td align="center"><input class="button" type="button" id="downloadBtn" value="下载"/></td>--%>
	</tr>
	</s:iterator>
	</s:if>
	<s:else>
