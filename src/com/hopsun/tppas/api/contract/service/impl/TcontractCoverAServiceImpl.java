...
@Service
public class TcontractCoverAServiceImpl extends BaseServiceImpl<TcontractCoverA,String> implements TcontractCoverAService{
	...
	public void updatecontractCover(TcontractCoverA tcontractCover,String tcontractId){
		...
		if (tcontractCover != null 
			...
			tcontractCoverA1.setTopicTitle(tcontractCover.getTopicTitle());
