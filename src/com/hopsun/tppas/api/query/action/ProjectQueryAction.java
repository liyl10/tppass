 ...
 * @Vsersion: 1.0
 */
public class ProjectQueryAction extends BaseAction{
	public final static Logger logger = Logger.getLogger(ProjectQueryAction.class.getName());
	...
	public String query() {
    	...
    	// 检索数据
		pager = projectQueryService.queryProjectInfo(param, pager.getPageNumber(), pager.getPageSize());
	...
	/**
	 * @return the projectQueryService
	 */
	public ProjectQueryService getProjectQueryService() {
		return projectQueryService;
	}

	/**
	 * @param projectQueryService the projectQueryService to set
	 */
	public void setProjectQueryService(
